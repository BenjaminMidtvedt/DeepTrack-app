...
import Models from "./models/index.jsx";
                ...
                <MuiThemeProvider theme={theme}>
                    <div className={classes.root + " background--dark"}>
                        ...
                        <Drawer
                            ...
                            classes={{
                                paper:
                                    classes.drawerPaper + " background--dark",
                            }}>
                            <div
                                className={
                                    classes.drawerHeader + " background--dark"
                                }>
                                <Typography
                                    variant="h4"
                        ...
                        <div
                            ...
                            <div id="main">
                                ...
                                <label
                                    htmlFor="logger__checkbox"
                                    className="logger background--dark">
                                    ...
                                    <div className="logger__buttons">
                                        <Button
                                            onClick={() => {
                                                const logger = document.getElementById(
                                                    "logger__inner"
                                                );
                                                logger.scrollTop =
                                                    logger.scrollHeight -
...
class Logger extends React.Component {
    ...
    componentWillUpdate() {
        ...
        this.isScrolledToBottom =
            logger.scrollHeight - logger.clientHeight <= logger.scrollTop + 5;
    }
