                ...
                <div
                    ...
                    <>
                        <ResultDisplay
                            ...
                            src={this.props.src}
                            height="100%"
                            width="100%"></ResultDisplay>
                        <ResultDisplay
                            title="Label"
                            src={this.props.label}
                            height="100%"
                            width="100%"></ResultDisplay>
                    </>
                </div>
            ...
            return (
                <div
                    ...
                    <div>
                        ...
                        <pre style={{ fontSize: 20, whiteSpace: "pre-wrap" }}>
        ...
        const onmousemove = (e2) => {
            requestAnimationFrame(() => {
                document.getElementById("display-left").style.width =
                    (100 * (e2.pageX - this.W0.left)) /
                        (this.W0.right - this.W0.left) +
                    "%";
            });
        };
                    ...
                    <div
                        ...
                        {this.state.comparison ? (
                            <ImageContainer
                                ...
                                onRequestRefresh={this.updateComparison.bind(
                                    this
                                )}
                            />
                        ) : (
